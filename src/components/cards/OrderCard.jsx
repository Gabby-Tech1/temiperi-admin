       ...
       <div className="border-2 rounded-md p-2 w-full">
            ...
            <div className="flex items-center justify-between mt-6">
                <div className="flex items-center gap-2">
                    ...
                    <div className="">
                        <p className="text-xs font-semibold text-gray-500 mt-4">Total Amount</p>
                        <p>{filteredOrders
                            .reduce((total, order) => {
                ...
                <div className="flex items-start ">
                    ...
                    <div className="text-gary-500 text-[13px] flex flex-col leading-3 text-gray-500 justify-start">
                        ...
                        <p className="flex items-center gap-1">Momo: GHC{momoAmount.toFixed(2)}</p>
                        <p className="flex items-center gap-1">Cash: GHC{cashAmount.toFixed(2)}</p>
                        <p className="flex items-center gap-1">Credit: GHC{paymentTotals.credit.toFixed(2)}</p>
                    </div>
                </div>
            </div>
          </div>
